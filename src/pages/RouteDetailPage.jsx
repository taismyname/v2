...
function DetailInner() {
  ...
  // helper: resize + convert base64
  const resizeAndConvert = (file, maxWidth = 800, quality = 0.7) => {
      ...
      <main className="flex-1 mx-auto w-full max-w-3xl px-4 py-6">
        <div className="bg-white rounded-2xl shadow-xl p-5 border border-zinc-100">
          ...
          <p className="text-sm mb-1">
            <span className="font-semibold">Từ:</span> {route.from}
          </p>
          <p className="text-sm mb-1">
            <span className="font-semibold">Đến:</span> {route.to}
          </p>
          <p className="text-sm mb-1">
            <span className="font-semibold">Quãng đường:</span> {route.distance} km
          </p>
          <p className="text-sm mb-4">
            <span className="font-semibold">Thời gian:</span> {route.time} h
          </p>
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <label
              className="cursor-pointer rounded-xl px-5 py-2.5 font-semibold text-white
